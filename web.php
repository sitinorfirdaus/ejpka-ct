...
Route::get('/tambahpengguna', [UserProfileController::class, 'create'])->name('tambahpengguna');
Route::put('/tambahpengguna', [UserProfileController::class, 'store'])->name('storepengguna');
Route::get('padampengguna/{id}', [UserProfileController::class, 'destroy'])->name('padampengguna');
